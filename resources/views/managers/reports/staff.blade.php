...
<div class="col-lg-12">
    ...
    <div class="col-lg-9">
        <section class="panel">
            <header class="panel-heading">Top 10 nhân viên bán hàng nhiều nhất (đã trừ trả hàng)</header>
            <div class="panel-body" >
                    ...
                    <table class="display table table-bordered" id="hidden-table-info">
                        ...
                        <tbody>
                            ...
                            <tr class="gradeX old" attr-key-old="<?=$key?>">
                                ...
                                ?>
                                <td>{!! $bill_sale['report_time']->staff->name; !!}</td>
...
<script type="text/javascript">
    ...
    if(!empty($bill_sales)){
        foreach ($bill_sales as $key => $bill_sale) {
            $user = $bill_sale['report_time']->staff->name;
