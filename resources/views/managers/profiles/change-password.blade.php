        ...
        <section>
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    {!! Form::open(array('route'=>'management.profile.change-password','id'=>'frmChangePassword','class'=>'form-horizontal filter-form-custom')) !!}             
        ...
        $("#frmChangePassword").validate({
            rules: {
                old_password: {
                    required: true,
                    remote: {
                        url: "/management/profile/check-password",
                        type: "POST",
                        data: {
